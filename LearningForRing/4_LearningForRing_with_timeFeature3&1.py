...
if __name__ == '__main__':
    ...
    for n in n_lst:
        ...
        for date in date_lst:
            ...
            if date < 10:
                test_date1,test_date2 = 0,9
            elif date < 20:
                test_date1,test_date2 = 10,19
            else:
                test_date1,test_date2 = 20,29
            ...
            # DiDi训练与验证数据
            DiDi_train_valid_df = DiDi_df1[(DiDi_df1['Date'].between(date-4,date))]
            ...
            with open(f'Model/{note}/TimeFeature_DiDi_n{n}_xgb_model.pkl', 'wb') as file:
            ...
            for Autonavi_pro in pro_lst:
                ...
                Autonavi_df1,DiAutonavi_df2 = train_test_split(Autonavi_df, test_size=0.2, random_state=42,shuffle=True)
                ...
                Autonavi_train_valid_df = Autonavi_df1[(Autonavi_df1['Date'].between(date-4,date))].reset_index(drop=True)
                ...
                Autonavi_test_df = DiAutonavi_df2[(DiAutonavi_df2['Date'].between(test_date1,test_date2))].reset_index(drop=True)
