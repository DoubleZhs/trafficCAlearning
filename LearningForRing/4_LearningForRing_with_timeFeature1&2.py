...
if __name__ == '__main__':
    ...
    for n in n_lst:
        ...
        # 读取训练数据
        DiDi_df = pd.read_csv(f"TimeFeature/1205/VehicleData_n{n}.csv",encoding='utf-8')
        data_df = pd.read_csv(f"TimeFeature/1205/VehicleData_n{n}_total.csv",encoding='utf-8')
        ...
        for date in date_lst:
            ...
            # DiDi训练与验证数据
            DiDi_train_valid_df = DiDi_df[(DiDi_df['Date'].between(date-9,date))]
            ...
            for Autonavi_pro in pro_lst:
                ...
                Autonavi_df = pd.read_csv(f"TimeFeature/1205/VehicleData_n{n}_pro{Autonavi_pro}.csv",encoding='utf-8')
                ...
                Autonavi_train_valid_df = Autonavi_df[(Autonavi_df['Date'].between(date-9,date))].reset_index(drop=True)
