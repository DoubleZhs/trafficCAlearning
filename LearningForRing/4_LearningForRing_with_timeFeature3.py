...
if __name__ == '__main__':
    ...
    for n in n_lst:
        ...
        for date in date_lst:
            ...
            # DiDi训练与验证数据
            DiDi_train_valid_df = DiDi_df1[(DiDi_df1['Date'].between(date-9,date))]
            ...
            for Autonavi_pro in pro_lst:
                ...
                Autonavi_train_valid_df = Autonavi_df1[(Autonavi_df1['Date'].between(date-9,date))].reset_index(drop=True)
